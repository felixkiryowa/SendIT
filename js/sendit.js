...
function CancelOrder(parcel_id){
    ...
    fetch('https://senditui.herokuapp.com/api/v2/parcels/'+parcel_id+'/cancel',
    {
        method:'PUT',
        headers: {
...
function MakeOrder1(parcel_id){
    fetch('https://senditui.herokuapp.com/api/v2/users/parcels/'+parcel_id,
    {
        method:'GET',
        headers: {
            'Accept': 'application/json',
...
function OrderHistory() {
    ...
    fetch('https://senditui.herokuapp.com/api/v2/parcels/delivered', {
    method: 'GET',
    headers: {
        'Accept': 'application/json',
        'Content-type': 'application/json',
